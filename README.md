...
User fills the event form.

JavaScript retrieves input values using getElementById.

A new <div> element is created dynamically.

Event details are inserted using template literals.
...
Two main cards (Add Event & My Events)
